...
def get_mermaid_png(mermaid_code, filename):
    state = {
        "code": mermaid_code,
        "mermaid": '{"theme":"dark", "themeVariables": {"background": "transparent"}}',
        "autoSync": True,
        "updateDiagram": True
    }
    json_str = json.dumps(state)
    b64 = base64.urlsafe_b64encode(json_str.encode('utf-8')).decode('utf-8')
    # Use /img/ instead of /svg/ for PNG
    url = f"https://mermaid.ink/img/{b64}?type=png&bgColor=!transparent"
...
get_mermaid_png(diagram1, 'public/diag1.png')
get_mermaid_png(diagram2, 'public/diag2.png')
get_mermaid_png(diagram3, 'public/diag3.png')
